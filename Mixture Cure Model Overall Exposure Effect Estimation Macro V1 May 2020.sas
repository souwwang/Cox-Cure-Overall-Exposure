*************************************************************************************************************************************************************************** ;
*	ESTIMATING THE OVERALL EXPOSURE EFFECTS FOR COX PROPORTIONAL HAZARDS MODELS WITH INTERVAL-CENSORED SURVIVAL DATA                                                        ;
*   Version 1.1, Uploaded 04/XX/2020 												                                                                                        ;
*																					               										                                    ;
*	Code written by Wei Wang (2020)													               										                                    ;
* 																					                										                                ;
*	Reference:																		               										                                    ;
* 	Wang W, Cong N, Zhang H and Zhang B (2020). Exposure Assessment for Cox Proportional Hazards Cure Models with Interval-Censored Survival Data.                          ;
* 	Statistical Methods in Medical Research. Submitted. 														                                                            ;
* 																					                                                                                        ;
*************************************************************************************************************************************************************************** ;
* 																					                										                                ;
*	PROGRAM DESCRIPTION:															                                                                                        ;
